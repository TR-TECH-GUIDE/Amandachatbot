...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Amanda", "@TheAmandabot")
        result = result.replace("Hi~", "Hello Friend I Am @TheAmandabot")
        result = result.replace("My dear great botmaster, SLBotsOfficial.", "Made By @TharukRenuja")
        result = result.replace("Have the control right.", "My Father Is @TharukRenuja")
        result = result.replace("I was created by SLBotsOfficial.")
...
async def redaura(client, message):
    ...
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @TharukRenuja")
    result = result.replace("Have the control right.", "My Father Is @TharukRenuja")
    result = result.replace("I was created by SLBotsOfficial.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
